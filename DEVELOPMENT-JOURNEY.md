...
| Before | After |
|--------|-------|
| ![First 3D Attempt 1](frontend/src/assets/screenshots/my-progress/first-3d-cover-attempt1.png) | ![First 3D Attempt 2](frontend/src/assets/screenshots/my-progress/first-3d-cover-attempt2.png) |
...
![Multiple Objects](frontend/src/assets/screenshots/my-progress/rendering-cover-to-scene.png)
...
![First Real Achievement](frontend/src/assets/screenshots/my-progress/initial-version-with-3d-mesh-render.png)
...
|---------------|---------------------|
| ![Early Prototype](frontend/src/assets/screenshots/my-progress/early-prototype-for-edit-delete-logic.png) | *Full-stack functionality achieved* |
...
|-----------|---------------|-----------------|
| ![UI Experiments](frontend/src/assets/screenshots/my-progress/new-play-button-with-title-bubble.png) | ![3DS Approach](frontend/src/assets/screenshots/my-progress/changed-approach-to-3ds.png) | ![First 3DS Mesh](frontend/src/assets/screenshots/my-progress/first-3ds-mesh.png) |
...
|--------------|---------------|--------------|
| ![Debug 1](frontend/src/assets/screenshots/my-progress/3ds-spline-debug1.png) | ![Debug 2](frontend/src/assets/screenshots/my-progress/3ds-spline-debug2.png) | ![Perfect Mapping](frontend/src/assets/screenshots/my-progress/first-good-mapped-3ds-mesh.png) |
...
|---------------------|-------------------|-------------------|
| ![Multiple Games](frontend/src/assets/screenshots/my-progress/multiple-3ds-games.png) | ![Camera System](frontend/src/assets/screenshots/my-progress/3ds-mesh-camera.png) | ![Selection Attempt](frontend/src/assets/screenshots/my-progress/selector-frame-frist-attempt.png) |
...
|-------------------|-----------------|-------------------|
| ![Selection Success](frontend/src/assets/screenshots/my-progress/selector-frame-version1.png) | ![Smoothing Before](frontend/src/assets/screenshots/my-progress/smoothing-with-lighting-texture-rgp-correction-before.png) | ![Smoothing After](frontend/src/assets/screenshots/my-progress/smoothing-with-lighting-texture-rgp-correction.png) |
...
|--------------------|---------------------|----------------|
| ![Side Buttons](frontend/src/assets/screenshots/my-progress/added-side-buttons.png) | ![Command Bar V1](frontend/src/assets/screenshots/my-progress/first-command-bar-attempt.png) | ![Command Bar V2](frontend/src/assets/screenshots/my-progress/command-bar-version2.png) |
...
|--------------------|------------------|-------------------|
| ![Stable Version](frontend/src/assets/screenshots/my-progress/stable-version.png) | ![Grid Icon](frontend/src/assets/screenshots/my-progress/grid-icon-first.png) | ![Grid Debug](frontend/src/assets/screenshots/my-progress/grid-layout1.png) |
| | | ![Multiple Layouts](frontend/src/assets/screenshots/my-progress/3-grid-layouts.png) |
...
|----------------|-----------------|--------------|
| ![Grid Animation](frontend/src/assets/screenshots/my-progress/grid-icon-version2.png) | ![First Light Theme](frontend/src/assets/screenshots/my-progress/first-light-theme.png) | ![Stable Themes](frontend/src/assets/screenshots/my-progress/stable-light-version.png) |
| ![Layout V3](frontend/src/assets/screenshots/my-progress/grid-layout-version3.png) | | ![Dark Version](frontend/src/assets/screenshots/my-progress/stable-dark-verson.png) |
...
|------------------|----------------|-------------------|
| ![Arrow Enhancement](frontend/src/assets/screenshots/my-progress/side-arrow-wip-after.png) | ![Audio Light](frontend/src/assets/screenshots/my-progress/wip-sound-button-light.png) | ![Final Stable](frontend/src/assets/screenshots/my-progress/stable-version2.png) |
...
|---------------------|-------------------|
| ![Final Light](frontend/src/assets/screenshots/my-progress/final-light.png) | ![Final Dark](frontend/src/assets/screenshots/my-progress/final-dark.png) |
